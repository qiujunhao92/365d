...
<div class="wp-block-group alignfull has-base-color has-theme-background-color has-text-color has-background" style="padding-top:0.5rem;padding-right:var(--wp--preset--spacing--40);padding-bottom:0.5rem;padding-left:var(--wp--preset--spacing--40)"><!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"14px","fontStyle":"normal","fontWeight":"500","lineHeight":"1.4"},"elements":{"link":{"color":{"text":"var:preset|color|secondary-bg"}}}},"textColor":"secondary-bg","fontFamily":"newsreader"} -->
<p class="has-text-align-center has-secondary-bg-color has-text-color has-link-color has-newsreader-font-family" style="font-size:14px;font-style:normal;font-weight:500;line-height:1.4"><?php echo esc_html__( 'Free express shipping ➺ On all orders $40 + Easy returns', 'woo-boost-dark' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:navigation {"overlayBackgroundColor":"tertiary","overlayTextColor":"primary","style":{"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"700","lineHeight":"1"},"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"blockGap":"9px"}}} /-->

<!-- wp:group {"style":{"typography":{"lineHeight":"1"},"spacing":{"blockGap":"0"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
...
<div class="wp-block-group"><!-- wp:paragraph {"style":{"typography":{"fontSize":"28px"},"spacing":{"padding":{"top":"var:preset|spacing|20","bottom":"0","left":"0","right":"0"}}},"className":"is-style-admin-icon"} -->
