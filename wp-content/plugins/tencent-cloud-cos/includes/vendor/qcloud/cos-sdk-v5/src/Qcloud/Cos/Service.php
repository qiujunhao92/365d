    ...
    public static function getService() {
        ...
        return array(
            ...
            'operations' => array(
                ...
                'GetBucketImageSlim' => array(
                    'httpMethod' => 'GET',
                    'uri' => '/{Bucket}?image-slim',
                    'class' => 'Qcloud\\Cos\\Command',
                    'responseClass' => 'GetBucketImageSlimOutput',
                    'responseType' => 'model',
                    'parameters' => array(
                        'Bucket' => array(
                            'required' => true,
                ...
                'DeleteBucketImageSlim' => array(
                    'httpMethod' => 'DELETE',
                    'uri' => '/{Bucket}?image-slim',
                    'class' => 'Qcloud\\Cos\\Command',
                    'responseClass' => 'DeleteBucketImageSlimOutput',
                    'responseType' => 'model',
                    'parameters' => array(
                        'Bucket' => array(
                            'required' => true,
                ...
                'PutBucketImageSlim' => array(
                    'httpMethod' => 'PUT',
                    'uri' => '/{Bucket}?image-slim',
                    'class' => 'Qcloud\\Cos\\Command',
                    'responseClass' => 'PutBucketImageSlimOutput',
                    'responseType' => 'model',
                    'data' => array(
                        'xmlRoot' => array(
                            'name' => 'ImageSlim',
            ...
            'models' => array(
                'AbortMultipartUploadOutput' => $generalResponseOutput,
                ...
                'DeleteBucketOutput' => $generalResponseOutput,
                ...
                'PutBucketAclOutput' => $generalResponseOutput,
                ...
                'GetBucketImageSlimOutput' => array(
                    'type' => 'object',
                    'additionalProperties' => true,
                    'properties' => array(
                        'RequestId' => array(
...
//                        ),
                ...
                'PutBucketImageSlimOutput' => $generalResponseOutput,
                'DeleteBucketImageSlimOutput' => $generalResponseOutput,
            )
        );
    }
}
