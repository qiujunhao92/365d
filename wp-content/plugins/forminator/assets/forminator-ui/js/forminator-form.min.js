...
!function (t) {
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}), FUI.inputStates = function (e) {
        ...
        if (o.is("input") || i.is(".forminator-poll") && (i.is(".forminator-ui") || i.is(".forminator-custom-form"))) return o.each((function () {
            ...
            e = t(this), o = e.closest(".forminator-field"), e.mouseover((function (t) {
                ...
                var o = t(e), i = o.closest(".forminator-field");
                o.focus((function (t) {
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}), FUI.inputMaterial = function (e) {
        var o = t(e), i = o.closest(".forminator-field"), n = i.find(".forminator-label"), r = o.closest("form");
        if (o.is("input") || r.is(".forminator-poll") && (r.is(".forminator-ui") || r.is(".forminator-custom-form"))) return o.parent().hasClass("forminator-input--wrap") || o.wrap('<div class="forminator-input--wrap"></div>'), n.length && (n.addClass("forminator-floating--input"), i.find(".forminator-input-with-icon").length && n.addClass("forminator-has_icon"), i.find(".forminator-input-with-phone").length && (n.addClass("forminator-has_phone"), i.find(".intl-tel-input").hasClass("allow-dropdown") && n.addClass("allow-dropdown"))), this
    }
}(jQuery), function (t) {
    "use strict";
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}), FUI.textareaMaterial = function (e) {
        ...
        if ((o.is("textarea") || r.is(".forminator-ui") || r.is(".forminator-custom-form")) && !o.hasClass("wp-editor-area")) return function () {
            if (o.parent().hasClass("forminator-textarea--wrap") || o.wrap('<div class="forminator-textarea--wrap"></div>'), n.length) {
                var t = (0 === n.height() ? 20 : n.height()) + 9;
                n.addClass("forminator-floating--textarea"), i.css({position: "relative"}), o.val() && i.addClass("forminator-is_filled"), i.hasClass("forminator-is_filled") && i.hasClass("forminator-is_active") || n.css({"padding-top": t + "px"}), o.css({"padding-top": t + "px"})
            }
        }(), this
    }
}(jQuery), function (t) {
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}), FUI.radioStates = function (e) {
        var o = t(e), i = o.find("input");
        if (o.is("label") && "radio" === i.prop("type")) return i.each((function () {
            t(this).on("click", (function () {
                var e = t(this), o = e.parent(), i = o.closest(".forminator-field").find(".forminator-radio");
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}), FUI.multiSelectStates = function (e) {
        var o = t(e), i = o.find(".forminator-option"), n = i.find("input");
        if (o.is(".forminator-multiselect") && 0 !== i.length) return n.each((function () {
            t(this).on("click", (function () {
                var e = t(this).parent();
                e.is(".forminator-is_checked") ? e.removeClass("forminator-is_checked") : e.addClass("forminator-is_checked")
            }))
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}), FUI.select2 = function () {
        t(".forminator-custom-form").each((function () {
            var e = t(this), o = e.data("form-id"), i = e.find(".forminator-select2");
            t.each(["bold", "flat", "default", "material", "none"], (function (n, r) {
                var a, s = "en", l = "Search", d = -1;
                e.hasClass("forminator-design--" + r) && i.length && i.each((function () {
                    var e = t(this), i = e.closest(".sui-dialog-content"),
                        n = i.length ? i : e.closest(".elementor-popup-modal");
                    a = !0 === e.data("rtl-support") ? "rtl" : "ltr", l = "" !== e.data("placeholder") ? e.data("placeholder") : "Search", s = "" !== e.data("language") ? e.data("language") : "en", d = !0 === e.data("search") ? 0 : -1, n.length || (n = t(document.body)), e.FUIselect2({
                        dir: a,
                        language: s,
                        placeholder: l,
                        dropdownCssClass: "forminator-custom-form-" + o + " forminator-dropdown--" + r,
                        minimumResultsForSearch: d,
                        dropdownParent: n
                    }).on("select2:opening", (function () {
                        e.data("select2").$dropdown.find(":input.select2-search__field").prop("placeholder", "" !== e.data("placeholder") ? e.data("placeholder") : "Search"), (e.closest(".hustle-popup").length || e.closest(".hustle-slidein")) && t(document.body).addClass("forminator-hustle-dropdown-fix")
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}), FUI.slider = function () {
        ...
        function o(t, e, o, i, n) {
            var r = t.find(".forminator-slider-amount"), a = t.find(".forminator-slide").data("is-range");
            r.find(".forminator-slider-value-min").html(e), a && (i === n ? (r.find(".forminator-slider-separator").hide(), r.find(".forminator-slider-value-max").html("")) : (r.find(".forminator-slider-separator").show(), r.find(".forminator-slider-value-max").html(o)))
            var myEvent = new CustomEvent("sliderChange", {
                detail: { obj:r, html:o, value: i },
                bubbles: true,    // 事件是否冒泡
        ...
        t(".forminator-slider").each((function () {
            var i = t(this), n = i.find(".forminator-slide"), r = i.find(".forminator-hidden-input"),
                a = i.hasClass("forminator-disabled"), s = n.data("is-range"), l = parseInt(n.data("min")) || 0,
                d = parseInt(n.data("max")) || 100, c = parseInt(n.data("value")) || l,
                f = parseInt(n.data("value-max")) || d, u = parseInt(n.data("step")) || 1,
                m = i.find(".forminator-slider-amount"), p = t('label[for="' + r.attr("id") + '"]');
            !0 !== n.data("init") && (n.slider(_objectSpread(_objectSpread({
                ...
                disabled: a,
                step: u
            }, s ? {values: [c, f]} : {value: c}), {}, {
                create: function (t, r) {
                    var a = e(i, c), l = s ? e(i, f) : null;
                    n.data("init", !0), m.find(".forminator-slider-hidden-min").val(c).change(), s && m.find(".forminator-slider-hidden-max").val(f).change(), o(i, a, l, c, f)
                }, slide: function (t, n) {
                    var r = s ? n.values[0] : n.value, a = s ? n.values[1] : null, l = e(i, r), d = s ? e(i, a) : null;
                    o(i, l, d, r, a)
                }, stop: function (t, e) {
                    var o = s ? e.values[0] : e.value, n = s ? e.values[1] : null;
                    e.handle === i.find(".ui-slider-handle")[0] ? m.find(".forminator-slider-hidden-min").val(o).change() : e.handle === i.find(".ui-slider-handle")[1] ? m.find(".forminator-slider-hidden-max").val(n).change() : m.find(".forminator-slider-hidden-min").val(o).change()
                }
            })), p.on("click", (function () {
